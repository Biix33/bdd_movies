...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.css" />
    ...
    <nav class="navbar navbar-inverse">
        ...
        <form action="" class="navbar-form navbar-right inline-form" method="get">
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-eye-open"></span> Rechercher</button>
            </div>
        </form>
    </nav>
